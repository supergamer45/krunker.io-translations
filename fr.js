...
settings.hitmarker.header Indicateur de tir
...
settings.hitmarker.custom Image de l’indicateur de tir
settings.hitmarker.custom.paste Lien image de l’indicateur de tir
...
windows.publish.map.paste Coller la data du mini-jeu
...
custom.host.ranked Impossible d'organiser le match pendant qu'il est classé.
funds.insufficient Fonds insuffisants
funds.out il semble qu'il vous manque des Krunkies.
custom.passcode.long Mot de passe trop long
custom.passcode.input Entrez le mot de passe du serveur pour rejoindre
custom.tryagain Veuillez réessayer.
purchase.kr.success {0} a etait KR ajouté à votre compte
limited.purchase.ask Voulez-vous vraiment acheter [{0}] pour {1} KR?
limited.purchase.success {0} a etait ajouter à votre inventaire
pretend.exit appuyez à nouveau sur [{0}] pour quitter
settings.loaded Paramètres chargés
settings.loaded.none Aucun paramètre trouvé
account.login.required Doit être connecté
account.banned.hack Ce compte a été banni pour hack.
account.banned.appeal Si vous souhaitez faire pardonner votre ban, contactez:
account.delete Vous pouvez demander la suppression de votre compte, si la demande n'est pas annulée dans les 14 jours, le compte et toutes les données associées seront supprimés définitivement.
account.delete.request Voulez-vous vraiment demander la suppression d'un compte?
account.delete.cancel Voulez-vous vraiment annuler la suppression du compte?
spin.free.available KR GRATUIT DISPONIBLE!
spin.free.claim Ce spin est disponible a réclamer une fois par heure après avoir terminé un match.
spin.free.disable Ces popup peuvent être désactivées dans les paramètres généraux
mod.reset.0 Prendra effet après réapparition.
mod.reset.1 Map Les objets ne sont pas réinitialisés
windows.profile.picture Change l'image de profile
...
stats.sprays spray placé
windows.host.default.settings L'activation des paramètres par défaut permet de stocker la progression du joueur et les meilleur scores
windows.host.default.commands *Les commandes de l'hôte sont désactivées dans ce mode: / noclip / god / smite etc.
windows.host.rewards L'activation de KR Rewards force le serveur à utiliser les paramètres par défaut et permet aux joueurs de gagner des KR à partir des fonds de la carte:
windows.store.wheels.sub Tentez votre chance et tentez de gagner de nouveaux skins!
windows.store.currency * Les prix en USD peuvent être convertis dans votre monaie locale à un taux de change défini par le fournisseur de paiement ou la banque
windows.store.creator Pensez à soutenir votre créateur de contenu préféré en utilisant un code créateur
windows.chall.customs Les défis ne peuvent pas être complétés dans les matchs personnalisés
twitch.link Voulez-vous vraiment lier un compte Twitch?
twitch.unlink Voulez-vous vraiment délier votre compte Twitch?
windows.clan.leave Voulez-vous vraiment quitter le clan?
windows.clan.delete Voulez-vous vraiment supprimer le clan?
windows.clan.kick Voulez-vous vraiment expulser {0} du clan?
windows.store.premium.purchase Voulez-vous vraiment acheter {0} jours de Premium?
windows.playerlist.ban Voulez-vous vraiment exclure {0} de ce jeu?
windows.playerlist.flag Voulez-vous vraiment signaler {0}?
windows.playerlist.unflag Voulez-vous vraiment oublier {0}?
windows.playerlist.punish Voulez-vous vraiment prendre action sur {0}?
`;
